...
category: lib
description: >
  Keep a reviewable decision trail for unattended or long-running work: a TSV
  log with one row per decision (what, why, evidence, result). Use for
  /show-me-your-work, autonomous runs, or work a human reviews after stepping
  away.
